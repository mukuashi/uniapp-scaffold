<template>
	<tm-mask v-model="value" position="bottom" @close="close">
		<view :class="[ prefixCls ]">
			...
			<view :class="[`${prefixCls}-action`, `${app.prefix}ui-center`]">
				<view :class="[`${prefixCls}-action-icon`]">
					<tm-icon v-if="changeYear" type="arrowhead_left" :color="yearArrowColor" @click="changeYearHandler(0)"></tm-icon>
				</view>
				<view :class="[`${prefixCls}-action-icon`]">
					<tm-icon v-if="changeMonth" type="arrow_left" :color="monthArrowColor" @click="changeMonthHandler(0)"></tm-icon>
				</view>
				<view :class="[`${prefixCls}-action-text`]">{{ showTitle }}</view>
				<view :class="[`${prefixCls}-action-icon`]">
					<tm-icon v-if="changeMonth" type="arrow_right" :color="monthArrowColor" @click="changeMonthHandler(1)"></tm-icon>
				</view>
				<view :class="[`${prefixCls}-action-icon`]">
					<tm-icon v-if="changeYear" type="arrowhead_right" :color="yearArrowColor" @click="changeYearHandler(1)"></tm-icon>
				</view>
			</view>
...
<script>
	 ...
	 * @example <tm-calendar v-model="show" :mode="mode"></tm-calendar>
	 */
