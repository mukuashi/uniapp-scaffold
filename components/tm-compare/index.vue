  ...
  <view :class="[prefixCls]">
    ...
    <view v-show="controlTab" :class="[`${prefixCls}-control`]">
      <view :class="[`${prefixCls}-control-top`]">
        ...
        <view>
          <tm-button width="120" size="small" @click.native="reset">reset</tm-button>
        ...
        <view class="move-warp">
          <tm-icon color="#000" type="more" class="arrow icon-top" rotate="270" @touchstart="touchstartTop" @touchend="touchend" @click="topMove"/>
          <tm-icon color="#000" type="more" class="arrow icon-right" @touchstart="touchstartRight" @touchend="touchend" @click="rightMove"/>
          <tm-icon color="#000" type="more" class="arrow icon-bottom" rotate="90" @touchstart="touchstartBottom" @touchend="touchend" @click="bottomMove"/>
          <tm-icon color="#000" type="more" class="arrow icon-left" rotate="180" @touchstart="touchstartLeft" @touchend="touchend" @click="leftMove"/>
        </view>
      </view>
