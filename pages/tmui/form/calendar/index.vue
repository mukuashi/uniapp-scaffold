  ...
  <view :class="[ `${app.prefix}ui-container`,`${app.prefix}ui-list` ]">
    <section>
      <tm-card :bordered="false">
        ...
        <view class="row">
          <tm-button type="success" @click.native="value = true">单日期模式</tm-button>
        </view>
      </tm-card>
    </section>
    <section>
      <tm-card :bordered="false">
        ...
        <view class="row">
          <tm-button type="success" @click.native="handleShowCalendar('range')"> 日期段模式</tm-button>
        </view>
      </tm-card>
    </section>
    <section>
      <tm-card :bordered="false">
        ...
        <view class="row">
          <tm-button type="success" @click.native="handleShowCalendar('buttontext')"> 文本模式</tm-button>
        </view>
      </tm-card>
    </section>
    <section>
      <tm-card :bordered="false">
        ...
        <view class="row">
          <tm-button type="success" @click.native="handleShowCalendar('dateText')">标题模式</tm-button>
        </view>
      </tm-card>
    </section>
      ...
      <tm-card :bordered='false'>
        ...
        <view :class="[ `${app.prefix}ui-justify`,`${app.prefix}ui-item` ]">
          ...
          <picker :value="colorIndex" :range="theme" range-key="name" @change="val=>handleCommonSwitch(val,'activeBgColor')">
            <tm-tag :bg-color="initValue.activeBgColor" color="#fff" size="large">{{theme[colorIndex].name}}</tm-tag>
          </picker>
        </view>
      </tm-card>
    </section>
...
<script>
  ...
  export default {
    ...
    onShareAppMessage() {
      return {
        title: 'Tag',
        path: 'pages/tmui/form/calendar/index',
      };
    },
    methods: {
      init() {
