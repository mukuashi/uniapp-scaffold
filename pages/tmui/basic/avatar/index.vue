    ...
    <section>
      <tm-card :bordered='false'>
        ...
        <view class="item item-right">
          <tm-avatar icon='cafe' :shadow="attrs.shadow"/>
        </view>
        <view class="item item-right">
          <tm-avatar icon='pay' icon-color="#fff" :avatar-bg="colors[0]" :shadow="attrs.shadow" />
        </view>
        <view class="item item-right">
          <tm-avatar icon='pay' icon-size="36" icon-color="#fff" :avatar-bg="colors[1]" :shadow="attrs.shadow" />
        </view>
      </tm-card>
    </section>
    <section>
      <tm-card :bordered='false'>
        ...
        <view class="item item-right">
          <tm-avatar :shadow="attrs.shadow">T</tm-avatar>
        </view>
        <view class="item item-right">
          <tm-avatar :shadow="attrs.shadow" avatar-bg="#2db7f5">M</tm-avatar>
        </view>
      </tm-card>
    </section>
    <section>
...
<script>
  ...
  export default {
    ...
    onShareAppMessage() {
      return {
        title: 'Avatar',
        path: 'pages/tmui/basic/avatar/index',
      };
    },
    methods: {
