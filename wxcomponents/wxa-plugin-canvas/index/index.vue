<template>
<uni-shadow-root class="wxa-plugin-canvas-index-index"><view class="container">
...
global['__wxRoute'] = 'wxa-plugin-canvas/index/index'
const main = {
    /**
     * 渲染块
     * @param {Object} params
...
export default global['__wxComponents']['wxa-plugin-canvas/index/index']
</script>
