...
qiniu.conf.ACCESS_KEY = '2ZsfoqbJh3UXrDzPJSnpw0B8s9ZpfAuaHBH3Qqzl';
qiniu.conf.SECRET_KEY = 'AJWAWS7Kbnnw2drx5s65cJe84L66YMQJl5294UPG';
...
function uploadFile(appName, file, dir) {
  ...
  return new Promise((resolve, reject) => {
    formUploader.putFile(uploadToken, key, path.join(dir, file.filename), putExtra, function (respErr, respBody, respInfo) {
      if (respErr) {
